...
Overview of consumer reserving agricultural products in AMAP/CSA system (consumer perspective only)
...
## AMAP - Product Reservation Dataflow Diagram - Level 1 DFD

![](amapp_dfd_productReservation_1.png)
...
|:----:|:----:|:---:|:----:|:--------:|:----:|
|Browse Products|Co-Producer|1.0 Product Catalog|[]||-1|
|Product Information|1.0 Product Catalog|Co-Producer|[]||-1|
|Product Data|AMAP Database|1.0 Product Catalog|[]||-1|
|Place Order|Co-Producer|2.0 Order Management|[]||-1|
|Order Confirmation|2.0 Order Management|Co-Producer|[]||-1|
|Check Availability|2.0 Order Management|1.0 Product Catalog|[]||-1|
|Availability Status|1.0 Product Catalog|2.0 Order Management|[]||-1|
|Update Inventory|2.0 Order Management|1.0 Product Catalog|[]||-1|
|Store Order|2.0 Order Management|AMAP Database|[]||-1|
|Order Details|AMAP Database|2.0 Order Management|[]||-1|
|Submit Reservation|Co-Producer|3.0 Reservation Processing|[]||-1|
|Reservation Confirmation|3.0 Reservation Processing|Co-Producer|[]||-1|
|Process Reservation|2.0 Order Management|3.0 Reservation Processing|[]||-1|
|Reservation Status|3.0 Reservation Processing|2.0 Order Management|[]||-1|
|Store Reservation|3.0 Reservation Processing|AMAP Database|[]||-1|
|Reservation Details|AMAP Database|3.0 Reservation Processing|[]||-1|
|Delivery Notification|4.0 Delivery Management|Co-Producer|[]||-1|
|Delivery Request|2.0 Order Management|4.0 Delivery Management|[]||-1|
|Store Delivery Info|4.0 Delivery Management|AMAP Database|[]||-1|
|Delivery Data|AMAP Database|4.0 Delivery Management|[]||-1|
...
<details>
  <summary>   INP02   --   Overflow Buffers</summary>
  <h6> Targeted Element </h6>
  <p> 3.0 Reservation Processing </p>
  <h6> Severity </h6>
  <p>Very High</p>
  <h6>Example Instances</h6>
  <p>The most straightforward example is an application that reads in input from the user and stores it in an internal buffer but does not check that the size of the input data is less than or equal to the size of the buffer. If the user enters excessive length data, the buffer may overflow leading to the application crashing, or worse, enabling the user to cause execution of injected code.Many web servers enforce security in web applications through the use of filter plugins. An example is the SiteMinder plugin used for authentication. An overflow in such a plugin, possibly through a long URL or redirect parameter, can allow an adversary not only to bypass the security checks but also execute arbitrary code on the target web server in the context of the user that runs the web server process.</p>
