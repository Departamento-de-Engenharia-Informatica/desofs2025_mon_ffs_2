    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AMAPAdministrators", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AMAPAdministrators_AspNetUsers_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CheckingAccounts", x => x.CoproducerId);
                    table.ForeignKey(
                        name: "FK_CheckingAccounts_CoproducersInfo_CoproducerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryRequirements = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_CoproducersInfo_CoproducerInfoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AMAPAdministrators_UserId",
                table: "AMAPAdministrators",
                column: "UserId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_CoproducerInfoId",
                table: "Orders",
